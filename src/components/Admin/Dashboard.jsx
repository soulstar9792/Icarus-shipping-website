  ...
  return (
    <div className="px-4 md:px-10 py-10 md:py-20 bg-custom-background">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
        ...
        <Card>
          <div className="flex items-center">
            <FaMoneyBill className={`${$GS.iconSize} text-custom-border mr-2`} />
            <div>
        ...
        <Card>
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className={`${$GS.textNormal_1}`}>{mockData.totalPendingOrders}</p>
            </div>
          </div>
        </Card>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <Card className="col-span-full bg-custom-background">
          ...
          <p className={`${$GS.textNormal_1}`}>Manage users, oversee orders, and adjust settings.</p>
