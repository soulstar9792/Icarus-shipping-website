    ...
    <section ref={ref} className="py-10 md:py-20 px-4 md:px-10 bg-custom-background relative overflow-hidden">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
        ...
        {[
          ...
          <div key={index} className={`rounded-small p-6 md:p-8 border-thin border-custom-border shadow-lg transition-shadow duration-300 bg-card-background group hover:border-hover-border hover:shadow-bright ${isVisible ? 'animate__animated animate__zoomIn' : ''}`}>
