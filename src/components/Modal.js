...
const Modal = ({ isVisible, onClose, imageData }) => {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
      <div className={`bg-white p-4 rounded-lg transition-transform duration-300 ${isAnimating ? 'scale-100' : 'scale-95'}`}>
        <h2 className="text-lg font-bold mb-2">Label Image</h2>
        <img src={imageData} width={400} height={500} alt="Label" className="mb-4" />
